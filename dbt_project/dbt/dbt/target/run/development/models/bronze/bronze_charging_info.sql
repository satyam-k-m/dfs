-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into insight_dev.INS_BKP.bronze_charging_info as DBT_INTERNAL_DEST
        using insight_dev.INS_BKP.bronze_charging_info__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
